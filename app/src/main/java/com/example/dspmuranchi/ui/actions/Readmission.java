 ...
 */
public class Readmission extends Fragment {
    WebView wb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view=inflater.inflate(R.layout.fragment_readmission, container, false);
        wb=(WebView)view.findViewById(R.id.readmissionview);
        ...
        wb.loadUrl("http://www.dspmuranchi.ac.in/Login_page_list.aspx");
